...
![Client Credentials](images/client\_credentials.png)
...
![Postman Authorization](images/postman\_authorization.png)

Now click on the button _Get New Access Token_, this will open the following dialog.

![Postman Client Credentials](images/postman\_client\_credentials.png)
...
![Postman Result](images/postman\_access\_token\_result.png)
...
![Password Credentials](images/ro\_password.png)

As of OAuth 2.1 the password resource owner grant is being deprecated and removed from the standard. The Spring Authorization Server already follows the upcoming OAuth 2.1 standard and therefore does not support this grant flow.
...
![PKCE](<images/authorization\_code\_schema (1).png>)
...
![Postman AuthCode](images/postman\_auth\_code.png)
